Файл "_exceptions__try to list all.py" служит для вывода всех известных exceptions при условии, что они изначально наследуются от класса BaseException (глубину наследования можно менять, сейчас это семь уровней).
...
'WinS' - from  dict_of_errno_as_Win_sockets_err_codes
       ...
       EADDRNOTAVAIL        :  errno :        -
        ...
        EAFNOSUPPORT        :  errno :        -
                               ...
                               C :            Address family not supported.
                               WinS :         None
           ...
           EAGAIN           :  errno :        11
                               ...
                               C :            Resource unavailable, try again (may be the same value as EWOULDBLOCK).
                               WinS :         None

          EALREADY          :  errno :        -
                               os_str by # :  ? (see below)
                               Linux :        Connection already in progress (POSIX.1-2001).
                               C :            Connection already in progress.
                               WinS :         None
        ...
        ECONNREFUSED        :  errno :        -
         ...
         ECONNRESET         :  errno :        -
          ...
          EDEADLK           :  errno :        -
                               ...
                               C :            Resource deadlock would occur.
                               WinS :         None
        ...
        EDESTADDRREQ        :  errno :        -
            ...
            EDOM            :  errno :        33
                               ...
                               C :            Mathematics argument out of domain of function.
                               WinS :         None
        ...
        EMEDIUMTYPE         :  errno :        -
           ...
           EMFILE           :  errno :        24
                               ...
                               C :            File descriptor value too large.
                               WinS :         None
        ...
        ENAMETOOLONG        :  errno :        38
         ...
         ENETRESET          :  errno :        -
                               ...
                               C :            Connection aborted by network.
                               WinS :         None
        ...
        ENETUNREACH         :  errno :        -
           ...
           ENFILE           :  errno :        23
                               ...
                               C :            Too many files open in system.
                               WinS :         None
          ...
          ENODATA           :  errno :        120
                               ...
                               C :            [OBSOLETE, XSR-optional]No message is available on the STREAM head read queue.
                               WinS :         None
          ...
          ENOEXEC           :  errno :        8
                               ...
                               C :            Executable file format error.
                               WinS :         None
         ...
         ENOMEDIUM          :  errno :        -
           ...
           ENOMSG           :  errno :        122
                               ...
                               C :            No message of the desired type.
                               WinS :         None
        ...
        ENOPROTOOPT         :  errno :        -
          ...
          ENOTCONN          :  errno :        -
                               ...
                               C :            The socket is not connected.
                               WinS :         None

          ENOTDIR           :  errno :        20
                               os_str by # :  Not a directory
                               Linux :        Not a directory (POSIX.1-2001).
                               C :            Not a directory or a symbolic link to a directory.
                               WinS :         None
      ...
      ESOCKTNOSUPPORT       :  errno :        -
          ...
          ESTRPIPE          :  errno :        -
           ...
           ETIME            :  errno :        137
                               ...
                               C :            [OBSOLETE, XSR-optional]Stream ioctl() timeout.
                               WinS :         None
        ...
        EWOULDBLOCK         :  errno :        -
                               os_str by # :  ? (see below)
                               Linux :        None
                               C :            Operation would block (may be the same value as EAGAIN).
                               WinS :         None
