# 2022-07-14 отсюда: https://man7.org/linux/man-pages/man3/errno.3.html
# конечно, надо из самого man, но уж ладно пока

dict_of_errno_from_Linux_man = {
    ...
    'EDEADLOCK': 'On most architectures, a synonym for EDEADLK.  On some architectures (e.g., Linux MIPS, PowerPC, SPARC), it is a separate error code File_locking_deadlock_error.',
    ...
    'EILSEQ': 'Invalid or incomplete multibyte or wide character (POSIX.1, C99). The text shown here is the glibc error description; in POSIX.1, this error is described as Illegal_byte_sequence.',
    ...
    'ENODATA': 'The named attribute does not exist, or the process has no access to this attribute; see xattr(7). In POSIX.1-2001 (XSI STREAMS option), this error was described as _ _ No message is available on the STREAM head read queue _ _.',
